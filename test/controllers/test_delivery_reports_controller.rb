...
class DeliveryReportsControllerTests < ControllerTestBase
  ...
  def setup
    ...
    @controller = DeliveryReportsController.new CONFIG, http_call_back: @response_catcher
  end
  ...
  def test_check_delivery_reports1()

    # Perform the API call through the SDK function
    result = @controller.get_check_delivery_reports()
